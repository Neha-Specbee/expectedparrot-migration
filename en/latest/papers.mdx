...
Send us an email at [info@expectedparrot.com](https://docs.expectedparrot.com/en/latest/) and we’ll provide credits to run your project for free at the Expected Parrot server.
